...
//        switch (getPosition()){
//            case 1:
//                objFragment = new ItemMap();
//                break;
//            case 2:
//                objFragment = new ItemMessages();
//                break;
//        }
...
//        fragmentManager.beginTransaction().replace(R.id.container, objFragment).commit();
    ...
    MyAdapter(String Titles[],int Icons[],String Name,String Email, Bitmap Profile,Context passedContext){ // MyAdapter Constructor with titles and icons parameter
